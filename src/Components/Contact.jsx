    ...
    return (
        <section className='container mt-4' id='contact'>
            ...
            <div className='fs-5 text-secondary mb-4'>
                Reach me at <a href="https://mail.google.com/mail/?view=cm&to=chhatrasinh345@gmail.com" className='text-decoration-none text-primary'>chhatrasinh345@gmail.com</a>
            </div>
